      ...
      <div id={styles.color}>
        <form action="/action_page.php" id={styles.formContainer}  >
          <div>
            ...
            <p>By creating an account you agree to our <a href="#" className={styles.tnc}>Terms & Privacy</a>.</p>

            <div className="form-group row">
              <label className="col-sm-2 col-form-label"></label>
              <div className="col-sm-10">
                <button ref={this.submitButton}  onClick = {e => { e.preventDefault(); this.handleSubmit(e)}} className={styles.signupbtn}>SIGN UP</button>
              </div>
            </div>
